...
const TV_ITEMS: TVItem[] = [
  {
    id: 1,
    channel: "CH 02",
    headline: "PRODUCTION STUDY: CASH EROSION",
    subhead: "CINEMATIC PACING & RETENTION TESTING",
    video: "/videos/inflation-1.mp4",
    date: "JUNE 2026",
    description: "A case study in motion graphics editing. This short-form reel explains financial depreciation concepts using fast cuts and high-impact kinetic typography. By structuring the hook within the first 2 seconds, we achieved an average viewer retention score of 82%.",
    width: 320,
    height: 240,
    defaultX: 0,
    defaultY: -15,
  ...
  },
  {
    id: 2,
    channel: "CH 04",
    headline: "STRATEGIC HOOKS: THE WATCHER COST",
    subhead: "AUDIENCE SEGMENTATION & VISUAL TIMING",
    video: "/videos/inflation-2.mp4",
    date: "JUNE 2026",
    description: "Edited with high-contrast color grading and dynamic audio design. This segment demonstrates optimal graphic-to-dialogue sync, designed to retain users who typically scroll past complex concepts on social media feeds.",
    width: 290,
    height: 215,
    defaultX: 295,
    defaultY: 20,
  ...
  },
  {
    id: 3,
    channel: "CH 07",
    headline: "VISUAL ASSETS: COMPENDIUM OF GROWTH",
    subhead: "3D ASSET INTEGRATION & RENDERING",
    video: "/videos/inflation-3.mp4",
    date: "JUNE 2026",
    description: "Showcasing custom 3D element rendering. We integrated vector animation assets with real-world stock footage to create a seamless visual representation of mathematical growth curves, ensuring the explanation remains visually engaging.",
    width: 300,
    height: 220,
    defaultX: -295,
    defaultY: 10,
  ...
  },
  {
    id: 4,
    channel: "CH 09",
    headline: "CREATIVE REEL: CAPITAL STATES",
    subhead: "SOUND DESIGN & IMPACT TRANSITIONS",
    video: "/videos/inflation-4.mp4",
    date: "JUNE 2026",
    description: "Focused on sound design dynamics. High-impact swoosh and whoosh audio effects were synced with visual transitions to keep pacing energetic. Sound effects and background tracks were custom-mixed for high speaker compatibility.",
    width: 220,
    height: 165,
    defaultX: -180,
    defaultY: -185,
  ...
  },
  {
    id: 5,
    channel: "CH 11",
    headline: "CREATIVE REEL: VIRAL ENGAGEMENT",
    subhead: "FORMATTING FOR ATTENTION SPANS",
    video: "/videos/video-689.mp4",
    date: "JUNE 2026",
    description: "Designed to meet modern attention spans on mobile devices. The visual template includes progress bars, captions, and bright graphic pop-ups, driving a 40% increase in content shareability and comment engagement.",
    width: 260,
    height: 195,
    defaultX: 180,
    defaultY: -190,
  ...
  },
  {
    ...
    subhead: "AI RUNTIMES & AUTOMATED CAPTIONS",
    video: "/videos/video-0.mp4",
    date: "JUNE 2026",
    description: "A custom technical pipeline showcasing automated video compilation. Using local scripts and model integration to auto-transcribe, caption, and cut audio, reducing post-production times significantly.",
    width: 245,
    height: 185,
    defaultX: -130,
    defaultY: 200,
  ...
  },
  {
    id: 7,
    channel: "CH 15",
    headline: "CAMPAIGN METRICS: ASSET DEPRECIATION",
    subhead: "DATA ILLUSTRATION & COMPARATIVE GRAPHICS",
    video: "/videos/car-depreciation.mp4",
    date: "JUNE 2026",
    description: "We designed comparative side-by-side graphic cards displaying finance rules. By utilizing bright accent highlights (like neon gold) against a dark backdrop, we increased user screenshot actions and visual bookmarks by 55%.",
    width: 310,
    height: 230,
    defaultX: 135,
    defaultY: 210,
